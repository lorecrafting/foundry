...
| — | EV-5 relations test | **done** | Landed at `b3c110e3`. Independently reviewed; the review blocked it on its own warrant text and found a larger defect, both answered — [log](../archive/IMPLEMENTATION-LOG.md) |
