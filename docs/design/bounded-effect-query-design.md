...
[Foundry](../../README.md) › [Docs](../README.md) › FR-18A bounded effect query design

> **Current status, 2026-09-22.** Implemented since this was written: the `bounded_effect_*` functions in `durable_store/protected_primitives.ex`, and the [B5 correction rereview](https://github.com/lorecrafting/foundry/blob/records/2026-09-24/docs/archive/fr-18a/b5-correction-rereview.md) is PASS. The body below is the dated design record and is not updated.
...
[independent review](https://github.com/lorecrafting/foundry/blob/records/2026-09-24/docs/archive/fr-18a/independent-review.md#b5--the-declared-public-bounds-sit-after-an-unbounded-protected-materialization).
