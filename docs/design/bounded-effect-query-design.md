...
> **Current status, 2026-09-22.** Implemented since this was written: the `bounded_effect_*` functions in `durable_store/protected_primitives.ex`, and the [B5 correction rereview](../archive/fr-18a/b5-correction-rereview.md) is PASS. The body below is the dated design record and is not updated.
...
[independent review](../archive/fr-18a/independent-review.md#b5--the-declared-public-bounds-sit-after-an-unbounded-protected-materialization).
