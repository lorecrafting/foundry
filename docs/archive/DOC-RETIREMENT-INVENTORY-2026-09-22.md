...
| [fr-18a/bounded-effect-query-design.md](../design/bounded-effect-query-design.md) | "design only; B5 remains blocking" | `protected_primitives.ex:3952–4021` (`bounded_effect_*`). [B5 correction rereview](fr-18a/b5-correction-rereview.md) is PASS |
