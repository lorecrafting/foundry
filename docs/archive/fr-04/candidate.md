...
```text
mix test test/foundry/coordinator_test.exs --seed 40423
...
```text
mix test test/foundry/autonomous_launch_test.exs \
...
rg 'Foundry.Herdr.Runner.System.run' lib/foundry/agent_server.ex
rg 'cleanup_orphan_panes|recover_inflight_agents' lib/foundry/coordinator.ex
git diff --check
```
