defmodule Foundry.Workflow.Kernel.Software.Dispositions do
  @moduledoc """
  ...
  import Foundry.Workflow.Kernel.Cancellation, only: [require_cancel_requested: 1]
  import Foundry.Workflow.Kernel.Executions, only: [executions: 1]

  import Foundry.Workflow.Kernel.Shared,
    only: [active_attempt: 1, require_active_attempt: 2, require_attempt_phase: 2]

  import Foundry.Workflow.Kernel.Software.Developer, only: [seal_developer_result: 3]
  alias Foundry.Workflow.Kernel.{Execution, State}
