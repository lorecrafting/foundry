defmodule Foundry.Workflow.Kernel.Software.Review do
  @moduledoc """
  Software workflow: reviewer planning, non-start settlement, verdict and close.
  """

  import Foundry.Workflow.Kernel.Control,
    only: [require_no_pending_cancel: 1, require_not_paused: 1]

  import Foundry.Workflow.Kernel.Executions,
    only: [
      add_execution: 3,
      close_execution: 4,
  ...
  alias Foundry.Workflow.Kernel.{Execution, Plan, State}
