defmodule Foundry.DurableStore.TransitionPlan do
  @moduledoc false
  ...
  # Foundry.Workflow.Kernel.Plan. The kernel's copy is the candidate-side
  ...
  alias Foundry.DurableStore.RecordCodec
