...
defmodule Foundry.Workflow.R4NoDirectApplyTest do
  @moduledoc """
  ...
  import Foundry.Test.AstModules, only: [nodes: 1, bindings: 1, resolve: 2]
  ...
  @kernel Foundry.Workflow.Kernel
  ...
  # `__MODULE__.Kernel` inside `defmodule Foundry.Workflow`, and any macro that
  ...
  @spellings [
    {"fully-qualified", "Foundry.Workflow.Kernel.apply(s, e)"},
    {"aliased", "alias Foundry.Workflow.Kernel\n Kernel.apply(s, e)"},
    {"alias renamed", "alias Foundry.Workflow.Kernel, as: K\n K.apply(s, e)"},
    {"multi-alias", "alias Foundry.Workflow.{Kernel, Other}\n Kernel.apply(s, e)"},
    {"parenless", "alias Foundry.Workflow.Kernel, as: K\n K.apply s, e"},
    {"space before paren", "alias Foundry.Workflow.Kernel, as: K\n K.apply (s), e"},
    {"capture", "alias Foundry.Workflow.Kernel, as: K\n f = &K.apply/2\n f.(s, e)"},
    {"reflection", "alias Foundry.Workflow.Kernel, as: K\n apply(K, :apply, [s, e])"},
    {"qualified reflection",
     "alias Foundry.Workflow.Kernel, as: K\n Kernel.apply(K, :apply, [s, e])"},
    {"module attribute", "@k Foundry.Workflow.Kernel\n @k.apply(s, e)"},
    {"atom literal", ":\"Elixir.Foundry.Workflow.Kernel\".apply(s, e)"},
    {"alias rebound by a later module",
     "defmodule A do\n alias Foundry.Workflow.Kernel\n def f(s, e), do: Kernel.apply(s, e)\nend\n" <>
       "defmodule B do\n alias Foundry.DurableStore.Kernel\nend"},
    {"renamed alias rebound later",
     "alias Foundry.Workflow.Kernel, as: K\n K.apply(s, e)\n alias Foundry.Test.Harness, as: K"},
    {"as: then warn: false", "alias Foundry.Workflow.Kernel, as: K, warn: false\n K.apply(s, e)"},
    {"warn: false then as:", "alias Foundry.Workflow.Kernel, warn: false, as: K\n K.apply(s, e)"},
    {"multi-alias with warn: false",
     "alias Foundry.Workflow.{Kernel, Other}, warn: false\n Kernel.apply(s, e)"},
    {"import", "import Foundry.Workflow.Kernel\n apply(s, e)"},
    {"import only:", "import Foundry.Workflow.Kernel, only: [apply: 2]\n apply(s, e)"},
    {"defdelegate", "defdelegate go(s, e), to: Foundry.Workflow.Kernel, as: :apply"},
    {"erlang reflection",
  ...
  test "the scan does not fire on a mention or on another module's apply/2" do
    path =
      fixture("""
      # Foundry.Workflow.Kernel.apply(s, e) in a comment
      alias Foundry.Test.Harness
      _ = "Foundry.Workflow.Kernel.apply(s, e) in a string"
      Harness.apply(s, e)
  ...
  test "the unchecked pin sees a call under a renamed alias" do
    path = fixture("alias Foundry.Test.Harness, as: H\n H.apply_unchecked(s, e)")
