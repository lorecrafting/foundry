defmodule Foundry.RuntimeRootTest do
  use ExUnit.Case, async: false

  alias Foundry.RuntimeRoot

  setup do
    configured = Application.fetch_env!(:foundry, :runtime_root)
    ...
    Application.delete_env(:foundry, :active_runtime_root, persistent: true)
    Application.delete_env(:foundry, :runtime_root_resolved, persistent: true)
    ...
    on_exit(fn ->
      ...
      Application.put_env(:foundry, :runtime_root, configured, persistent: true)
  ...
  defp restore_app_env(key, nil),
    do: Application.delete_env(:foundry, key, persistent: true)

  defp restore_app_env(key, value),
    do: Application.put_env(:foundry, key, value, persistent: true)
end
